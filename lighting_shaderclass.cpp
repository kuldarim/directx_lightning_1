...
bool LightingShaderClass::Render(ID3D11DeviceContext* deviceContext, D3DXMATRIX& worldMatrix, D3DXMATRIX& viewMatrix, 
							  D3DXMATRIX& projectionMatrix, D3DXVECTOR3 cameraPosition, MaterialBufferType material,LightColorBufferType light)
{
	bool result;


	// Set the shader parameters that it will use for rendering.
	result = SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, cameraPosition, material,light);
	if(!result)
	{
		return false;
	}
										   ...
										   D3DXMATRIX& projectionMatrix, D3DXVECTOR3 cameraPosition, MaterialBufferType material, LightColorBufferType light)
{
	...
	CdataPtr->LightPosition1 = light.myLightPosition;
	CdataPtr->LightDifuse = light.myLightDifuseColor;
	CdataPtr->LightAmbient = light.myLightAmbientColor;
	CdataPtr->LightAtt = light.myLightAtt;
	CdataPtr->LightDir = light.myLightDir;
	CdataPtr->LightCone = light.myLightCone;
	CdataPtr->LightRange = light.myLightRange;
